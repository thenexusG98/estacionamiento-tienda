...
### v0.1.6 - 10/02/2026
- feat: enhance latest.json generation and tagging process for Windows support
...
- feat: enhance automatic update process with additional file formats and configurations
